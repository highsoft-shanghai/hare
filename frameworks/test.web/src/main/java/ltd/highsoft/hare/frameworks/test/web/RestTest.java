...
import static ltd.highsoft.hare.frameworks.security.core.SecurityContext.ANONYMOUS;
...
public class RestTest {
    ...
    private Filter docFilter(Documentation doc) {
        ...
        return RestAssuredRestDocumentation.document(doc.identifier(), ArrayUtils.addAll(doc.snippets(), ApiDocUtils.apiHeader(authRequired), new ApiSnippet()));
    }
