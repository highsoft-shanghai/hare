...
public class LoginByUsernameAndPasswordUseCaseTest extends ApiTest {
    ...
    private static final Role OPERATORS_2 = new Role(ScopedId.id("operators2", "highsoft"), name("Operators2"), GrantedAuthorities.of("f3"), Remarks.remarks("Remarks for operators"), false);
