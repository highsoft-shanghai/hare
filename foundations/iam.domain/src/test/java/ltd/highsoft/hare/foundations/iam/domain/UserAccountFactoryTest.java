...
class UserAccountFactoryTest {
    ...
    void should_be_able_to_create_user_accounts() {
        ...
        UserAccount userAccount = factory.newUserAccount("John@Highsoft", new UserAccountOwner(id("john"), id("highsoft")), Set.of("role-a", "role-b"));
        assertThat(userAccount.id()).isEqualTo(id("fixed-id"));
        assertThat(userAccount.name()).isEqualTo("John@Highsoft");
        assertThat(userAccount.owner()).isEqualTo(new UserAccountOwner(id("john"), id("highsoft")));
